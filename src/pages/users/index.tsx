...
const Index = () => {
  ...
  return (
    <>
                   ...
                   {userList.map((sub:any, index:any) => (
                     ...
                     >
                       <td className="p-4 text-left md:p-2 lg:p-4 md:py-3 flex items-center gap-1">
                         <Image src={sub?.profile_pic} alt="ProfileIcon" className="rounded-lg" width={20} height={20}/>
                         {sub?.name}
                       </td>
                       ...
                       <td className="text-center ">
                         <div className="flex gap-2 items-center justify-center">
                           <button className="px-2 py-1 rounded-2 bg-primary font-bold"
      ...
      {isBanModal && (
        <BanModal closeModal={closeModal} isBanModal={isBanModal} selectedName={selectedName}/>
      )}
    </>
  );
};
